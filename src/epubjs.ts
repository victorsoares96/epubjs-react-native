  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      e.a = class {
        ...
        join(t) {
          return s.a.join(this.directory, t);
        }
        resolve(t) {
            ...
            n(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = Array.from(this.range.getClientRects()).map(
                      function (t) {
          ...
          n(e, [
            {
              ...
              value: function () {
                ...
                for (
                  ...
                  h.setAttribute("x1", a.left - i.left + n.left),
                    h.setAttribute("x2", a.left - i.left + n.left + a.width),
                    h.setAttribute("y1", a.top - i.top + n.top + a.height - 1),
                    h.setAttribute("y2", a.top - i.top + n.top + a.height - 1),
    ...
    function (t, e, i) {
      ...
      var S = class {
          ...
          navItem(t, e) {
            ...
            let o = this.tocPath.join(s);
            i || (i = o);
            let a = n.textContent || "",
              h = [],
              l = Object(r.filterChildren)(t, "ol", !0);
            return (
